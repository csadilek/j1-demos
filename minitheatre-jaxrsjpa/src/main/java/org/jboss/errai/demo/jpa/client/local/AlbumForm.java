...
public class AlbumForm extends Composite {
  ...
  // Binding. See the grocery list demo for the full-on Errai development
  // experience.
  ...
  private void updateUIFromAlbum() {
    ...
    // Note: with Errai Data Sync, the code in this method would be unnecessary.
    // See the Grocery List demo for an example.
